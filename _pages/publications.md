...
<p>
	...
	<img src="{{ site.baseurl }}/files/positive.png" style="width: 75%; display: block; margin-left: auto; margin-right: auto; margin-top: 15px;"/>
	<img src="{{ site.baseurl }}/files/negative.png" style="width: 75%; display: block; margin-left: auto; margin-right: auto; margin-top: 15px;"/>
	<img src="{{ site.baseurl }}/files/trefoil_writhe.png" style="width: 75%; display: block; margin-left: auto; margin-right: auto; margin-top: 15px;"/>
